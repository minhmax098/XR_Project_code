...
public class MeetingStartingHandler : MonoBehaviourPunCallbacks
{
    ...
    async Task GetMeetingCodeFromLogicServer()
    {
        try
        {
            ...
            APIResponse<CreateMeetingRoomResponseInfo> createMeetingRoomResponse = await UnityHttpClient.CallAPI<APIResponse<CreateMeetingRoomResponseInfo>>(APIUrlConfig.POST_CREATE_MEETING_ROOM, UnityWebRequest.kHttpVerbPOST, createMeetingRoomRequest);
    ...
    public override void OnCreateRoomFailed(short code, string message)
    {
        ...
        Toast.Show(MeetingConfig.failedToCreateRoom);
    }
    ...
    {
        photonGameServerConnectionState = PhotonGameServerConnectionState.None;
        Toast.Show(MeetingConfig.failedToJoinRoom);
    }
    ...
    public override void OnDisconnected(DisconnectCause cause)
    {
        ...
        if (numberOfConnectionAttempt >= MeetingConfig.maxNumberOfConnecetionAttempt)
        {
            ...
            Toast.Show(MeetingConfig.failedToConnectPhoton);
        }
        ConnectToMultiplayerServer();
    }
