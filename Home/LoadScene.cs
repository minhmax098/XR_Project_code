    ...
    public class LoadScene : MonoBehaviour
    {
        ...
        async Task LoadDataFromServer()
        {
            ...
            try
            {
                ...
                APIResponse<List<OrganForHome>> organsResponse = await UnityHttpClient.CallAPI<APIResponse<List<OrganForHome>>>(APIUrlConfig.GET_ORGAN_WITH_LESSONS, UnityWebRequest.kHttpVerbGET);
