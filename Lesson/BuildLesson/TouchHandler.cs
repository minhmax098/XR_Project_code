...
namespace BuildLesson
{
    public class TouchHandler : MonoBehaviour
    {
        ...
        void onCreatedLabel(GameObject destroyedObj)
        {
            ...
            // s.transform.localScale = new Vector3 (0.2f, 0.2f, 0.2f) * ObjectManagerBuildLesson.Instance.OriginScale.x / ObjectManagerBuildLesson.Instance.OriginObject.transform.localScale.x * 0.2f;
            ...
            // labelObject.transform.localScale = labelObject.transform.localScale / (ObjectManagerBuildLesson.Instance.OriginObject.transform.localScale.x / ObjectManagerBuildLesson.Instance.OriginScale.x);
        ...
        private void SetLabel(string name, Vector3 hitpoint, GameObject currentObject, GameObject parentObject, Vector3 rootPosition, GameObject label, GameObject editLabel)
        {
            ...
            // TODO: Consider, may be fixed the local scale of sphere is 10, then localScale *= localScale * ObjectManagerBuildLesson.Instance.OriginScale.x / ObjectManagerBuildLesson.Instance.OriginObject.transform.localScale.x
